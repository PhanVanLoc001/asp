...
namespace FashionShopASP.Controllers
{
    public class InvoiceDetailsController : Controller
    {
        ...
        public InvoiceDetailsController(FashionShopAdmin context)
        {
            _context = context;
        }
        ...
        {
            var fashionContext = _context.InvoiceDetail.Include(i => i.Invoice).Include(i => i.Product);
        ...
        public async Task<IActionResult> Create([Bind("Id,InvoiceId,ProductId,Quantity,UnitPrice")] InvoiceDetail invoiceDetail)
        {
            ...
            ViewData["ProductId"] = new SelectList(_context.Product, "Id", "Name", invoiceDetail.ProductId);
            return View(invoiceDetail);
        }
