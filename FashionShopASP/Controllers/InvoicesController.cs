...
namespace FashionShopASP.Controllers
{
    public class InvoicesController : Controller
    {
        ...
        public InvoicesController(FashionShopAdmin context)
        {
            _context = context;
        }
        ...
        {
            var fashionContext = _context.Invoice.Include(i => i.Account);
        ...
        public async Task<IActionResult> Create([Bind("Id,Code,AccountId,IssuedDate,ShippingAddress,ShippingPhone,Total,Status")] Invoice invoice)
        {
            ...
            ViewData["AccountId"] = new SelectList(_context.Account, "Id", "Username", invoice.AccountId);
            return View(invoice);
        }
